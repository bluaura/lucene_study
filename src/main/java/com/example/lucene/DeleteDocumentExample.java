...
public class DeleteDocumentExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 문서 삭제
        deleteDocumentByISBN(index, "193398817");
    ...
    private static void deleteDocumentByISBN(Directory index, String isbn) throws IOException {
        ...
        System.out.println("Document with ISBN " + isbn + " has been deleted.");
    }
